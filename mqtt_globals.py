...
# Theses values can be replaced with TypeName if known
pTypeLux=                            0xF6
sTypeLux=                            0x01
...
sSwitchSelectorSwitch=                0x3E
sSwitchGeneralSwitch=                0x49

#TypeName : this will set the values for Type, Subtype and Switchtype
tn_null=""
...
#---Alterative format. Can be defined by the user 
CS_gps_text="gps"
CS_weight="weight"
CS_rain="rain"
CS_soil_moist="soil_moisture"
CS_voltage="voltage"
CS_counter_incremental="counter_incremental"
CS_counter="counter"
CS_managed_counter="managed_counter"
CS_contact="contact"
CS_alert="alert"
CS_currentSensor="currentSensor"
CS_percentage="percentage"



#############
##    ASSOCIATION ARRAYS : can be defined by the end user
#CS_payload_to_MS[Name in the Chirpstack App Server]==[MYSENSORS_SensorType, MYSENSORS_Type]
#Will publish on the MySensorsMQTT 
CS_payload_to_MS={
    ...
    CS_currentSensor:[S_MULTIMETER,V_CURRENT],
    CS_percentage:[S_COVER,V_PERCENTAGE],
}
...
CS_cayenne_to_DZ={
    ...
    CS_presenceSensor:[tn_motion, pTypeSwitch,sSwitchGeneralSwitch,"motion"],
    ...
    CS_gps_text:[tn_text,pTypeGeneral,sTypeTextStatus,"gps_text"],
    CS_weight:[tn_weight,pTypeScale,sTypeWeight,"weight"],
    CS_rain:[tn_rain,pTypeRain,sTypeRain,"rain"],
    CS_soil_moist:[tn_soil_moist,pTypeGeneral,sTypeSoilMoisture,"soil_moisture"],
    CS_voltage:[tn_volt,pTypeGeneral,sTypeVoltage,"voltage"],
    CS_counter_incremental:[tn_counter_incr,pTypeGeneral,sTypeCounterIncremental,"counter_incremental"],
    CS_managed_counter:[tn_kwh,pTypeGeneral,sTypeManagedCounter,"managed_counter"],#Managed Counter (dating)
    CS_counter:[tn_kwh,pTypeCounter,sTypeCounter,"counter"],    #Simple Counter 
    CS_contact:[tn_contact,pTypeSwitch,sSwitchSelectorSwitch,"contact"],
    CS_alert:[tn_alert,pTypeSwitch,sSwitchSelectorSwitch,"alert"],
    CS_currentSensor:[tn_current_amp,pTypeGeneral,sTypeCurrent,"current"],
    CS_percentage:[tn_percent,pTypeGeneral,sTypePercentage,"percentage"],
}
